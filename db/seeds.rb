...
Note.create!(title: 'CodeClan W4D3 notes', note: 'Rails associatins and partials today. Lots of fun :)')
Note.create!(title: 'How to build a table', note: 'Get sticks, get plank, stick sticks to plank.')
...
Note.first(4).last.tags << code_clan << ruby << programming
Note.first(5).last.tags << diy
